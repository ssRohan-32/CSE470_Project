 ...
 * Module 4: Feature 12 — Discrepancy Algorithm [High Cyclomatic Complexity]
 */
...
// Feature 12 (M3): Anonymous B2B Review [Observer Pattern]
router.get('/feedback',  guard, PumpController.showFeedback);
router.post('/feedback', guard, PumpController.submitFeedback);

// Feature 12 (M4): Discrepancy Algorithm
router.get('/discrepancy',      guard, PumpController.showDiscrepancy);
router.post('/discrepancy/log', guard, PumpController.addDeliveryLog);
